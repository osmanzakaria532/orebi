...
import ContainerFluid from "./layer/ContainerFluid";
    ...
    <>
      <ContainerFluid>
        <Container className="px-3">
          <h3 className="text-[40px] font-bold font-DM mb-[48px]">
            New Arrivals
          </h3>
          <Slider {...settings} className="ml-[-20px] newArrivesCopy">
            <div className="w-[376px]">
              <div className="relative group">
                <Image
                  className="w-full relative"
                  src="../src/assets/n_i_1.jpg"
                />
                <div className="absolute bottom-0 w-full bg-white h-0 py-[25px] invisible group-hover:h-[156px] group-hover:visible transition duration-500">
            ...
            <div className="w-[376px]">
              <div className="relative group">
                <Image className="w-full " src="../src/assets/n_i_2.jpg" />
                <div className="absolute bottom-0 w-full bg-white h-0 py-[25px] invisible group-hover:h-[156px] group-hover:visible transition duration-500">
                  <Flex className="flex-col items-end justify-between h-full">
                    <Flex className="items-center gap-x-[15px] mr-[30px] cursor-pointer">
                      <p>Add to Wish List</p>
            ...
            <div className="w-[376px]">
              <div className="relative group">
                <Image className="w-full " src="../src/assets/n_i_3.jpg" />
                <div className="absolute bottom-0 w-full bg-white h-0 py-[25px] invisible group-hover:h-[156px] group-hover:visible transition duration-500">
                  <Flex className="flex-col items-end justify-between h-full">
                    <Flex className="items-center gap-x-[15px] mr-[30px] cursor-pointer">
                      <p>Add to Wish List</p>
            ...
            <div className="w-[376px]">
              <div className="relative group">
                <Image className="w-full " src="../src/assets/n_i_4.jpg" />
                <div className="absolute bottom-0 w-full bg-white h-0 py-[25px] invisible group-hover:h-[156px] group-hover:visible transition duration-500">
                  <Flex className="flex-col items-end justify-between h-full">
                    <Flex className="items-center gap-x-[15px] mr-[30px] cursor-pointer">
                      <p>Add to Wish List</p>
